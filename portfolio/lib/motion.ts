...
/* ═══════════════════════════════════════════════════════════════════════════
   VIEWPORT CONFIG (§4.9, §6)
   ═══════════════════════════════════════════════════════════════════════════ */

/** Scroll-triggered reveals fire at ~20% viewport visibility.
 *  once: true — never re-triggered (MOTION_SYSTEM.md §6). */
export const VIEWPORT_REVEAL = { once: true as const, amount: 0.2 as const };
