...
function CaseSection({
  ...
  return (
    <section className="rounded-xl border themed-static-panel p-6 sm:p-7">
      <Label>{title}</Label>
      <div
...
export default async function ProjectDetailPage({ params }: ProjectPageProps) {
  ...
  return (
    <div className="w-full max-w-5xl mx-auto px-6 sm:px-10 lg:px-16 py-16 sm:py-24">
      ...
      <section
        className="relative overflow-hidden border-b pb-10 sm:pb-12"
        ...
        <div className="relative z-10">
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            <a
              ...
              className="inline-flex items-center gap-2 rounded-full border px-4 py-2 text-sm transition-all motion-feedback-transition hover:opacity-100"
              style={{
                fontFamily: "var(--font-geist-sans), system-ui, sans-serif",
            ...
            {project.liveUrl && (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                id={`project-detail-${project.id}-live`}
